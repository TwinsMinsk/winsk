            ...
            <div className="max-w-[1000px] mx-auto w-full px-6">
                ...
                <header className="mb-16 border-b border-[var(--color-border)] pb-12">
                    ...
                    <p className="text-xl text-[var(--color-text-secondary)] font-light">
                        Turning complexity into winning products. Full-Stack engineering, Architecture, and AI-automation.
                    </p>
                </header>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-16">
                    ...
                    <div className="md:col-span-1">
                        <div className="sticky top-24 bg-[var(--color-bg-elevated)] border border-[var(--color-border)] rounded-2xl p-6">
                            <h3 className="text-lg font-bold text-[var(--color-text-primary)] mb-4 font-mono tracking-tight">Key Facts</h3>
                            <ul className="space-y-4 text-sm text-[var(--color-text-secondary)]">
                                <li className="flex flex-col">
                                    <span className="text-[var(--color-text-primary)] mb-1">— Stack</span>
                                    Next.js, Python, PostgreSQL, AI APIs
                                </li>
                                <li className="flex flex-col">
                                    <span className="text-[var(--color-text-primary)] mb-1">— Services</span>
                                    SaaS, CRM/ERP, Telegram Bots, AI Apps
                                </li>
                                <li className="flex flex-col">
                                    <span className="text-[var(--color-text-primary)] mb-1">— Location</span>
                                    Minsk / GMT+3 / Remote
                                </li>
                            </ul>
                            ...
                            <div className="mt-8 pt-6 border-t border-[var(--color-border)]">
                                ...
                                <div className="flex gap-4 justify-center mt-6">
                                    <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="text-[var(--color-text-secondary)] hover:text-white transition-colors text-xs font-mono">[ GitHub ]</a>
                                    <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="text-[var(--color-text-secondary)] hover:text-white transition-colors text-xs font-mono">[ LinkedIn ]</a>
                                </div>
                            </div>
                        </div>
                    </div>
